...
const Setup: React.FC = () => {
  ...
  const performSetupStep = async (endpoint: string, processingMessage: string, successMessage: string, errorMessage: string, progressValue: number): Promise<void> => {
  ...
  const startSetupProcess = async (): Promise<void> => {
